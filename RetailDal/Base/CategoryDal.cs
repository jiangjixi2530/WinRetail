...
namespace Win.Soft.Retail.RetailDal
{
    public class CategoryDal
    {
        ...
        public int Add(Category model)
        {
            ...
            strSql.Append("Code,Name,Sequence,Remark)");
        ...
        public Category GetModel(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ID,Code,Name,Sequence,Remark from tb_Category ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
        ...
        /// 得到一个对象实体
        /// </summary>
        public Category DataRowToModel(DataRow row)
        {
            Category model = new Category();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,Code,Name,Sequence,Remark ");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" ID,Code,Name,Sequence,Remark ");
            strSql.Append(" FROM tb_Category ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
